#!/usr/bin/perl
# Modified by Pascal to deal with the UMI
#This is a script for analysing spike-in controls in RNAseq data; 
# Usage: ./scriptname FILENAME.seq | cut -f 4,5,6 | sort | grep -v N | uniq | cut -f 1,2 | sort | uniq -c > OUTPUTFILENAME.tsv
